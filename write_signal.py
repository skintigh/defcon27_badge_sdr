...
#preamble_bytes = [0xa0,0x87,0] #worked  (1 bit difference)
#preamble_bytes = [0x80,0x86,0] #fail
#preamble_bytes = [0x80,0x07,0] #fail
#preamble_bytes = [0x81,0x87,0] #worked (1 bit difference)
#preamble_bytes = [0xff,0x87,0] #fail
#preamble_bytes = [0x82,0x87,0] #worked
#preamble_bytes = [0x84,0x87,0] #works very infrequently, probably due to lucky noise (1 bit difference)
#preamble_bytes = [0x83,0x87,0] #worked (2 bit difference)
#preamble_bytes = [0xc0,0x87,0] #fail
#preamble_bytes = [0x80,0x00,0] #fail
#preamble_bytes = [0xc0,0xff,0x55] #fail

#new standard signal
#data_bytes = [0x80,0x87,0] + [0,0,0,0,11] + [0x42,1,2,3,4,5,6,7,8,9,0x45] 
...
#Defcon game packet for hacked NFMI
