...
echo This script may not work... an address may be wrong?
...
sox synthetic_signal.wav recordings/silence_1000ms.wav synthetic_print_seth_for_stock_with_hacked_NFMI_FW..wav
...
./craft_multipart_attack.sh
sox synthetic_print_seth_for_stock_with_hacked_NFMI_FW..wav synthetic_signal.wav recordings/silence_1000ms.wav temp/out.wav #concat with delay
mv temp/out.wav synthetic_print_seth_for_stock_with_hacked_NFMI_FW..wav
...
./craft_multipart_attack.sh
sox synthetic_print_seth_for_stock_with_hacked_NFMI_FW..wav synthetic_signal.wav recordings/silence_2281ms.wav temp/out.wav #concat with delay
mv temp/out.wav synthetic_print_seth_for_stock_with_hacked_NFMI_FW..wav
