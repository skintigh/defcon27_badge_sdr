...
#should be length 11, all 0s
#[0, 0, 4, 4, 2, 7, 7, 4, 6, 7, 5, 6,   2, 3, 3, 6, 7, 7, 0, 1, 3, 2, 4, 2, 2, 2, 7, 5, 2, 6, 1, 4,     5, 3, 1, 5,  7, 0, 3, 6,  4, 0, 7, 3,  0, 4, 1, 4,  4, 2, 7, 4,  6, 2, 0, 2,  0, 7, 6, 6,  1, 6, 4, 1,  5, 2, 3, 4,  4, 7, 5, 1,  1, 2, 5, 5]
# rec  glitch                           4 2 1 0  7 0 6 1  3 2 4 2  2 2 7 5  0 5 2 6                                                       2 2 0 2  0 3 4 5  4 7 6 1  2 5 3 2  4 1 5 4  6 2 0 2  0 7 6 6  1 6 4 1    5 2 3 4  4 7 5 1  1 2 5 5               5 0 4 4  6 5 1 5  2 4 3  46
#dzeros_symbols = [4,4,4,0,4,0,4,0,2,4,6,0,0,0,0,0,6,4,2,0,0,0,4,0,0,0,0,0,0,0,0,0, 2,3,3,6, 7,7,0,1, 3,2,4,2, 2,2,7,5, 0,3,3,2,          5,4,3,5, 7,0,3,6, 4,0,7,3, 0,4,1,4, 4,2,7,4, 6,2,0,2, 0,7,6,6, 1,6,4,1,   5, 2, 3, 4,  4, 7, 5, 1,  1, 2, 5, 5,   7,7,7,3, 0,3,1,6, 4,4,0,0, 0,0,0,0]

#all 0s, 7 7 7, 0 CRC   new zeros 
#[0, 0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0,   2, 3, 3, 6, 7, 7, 0, 1, 3, 2, 4, 2, 2, 2, 7, 5, 0, 3, 3, 2,     5, 4, 3, 5,  7, 0, 3, 6,  4, 0, 7, 3,  0, 4, 1, 4,  4, 2, 7, 4,  6, 2, 0, 2,  0, 7, 6, 6,  1, 6, 4, 1,     3, 1, 4, 4,  0, 7, 7, 3,  5, 2, 7, 7,    5, 0, 6, 1, 0, 3, 1, 6, 4, 4, 0, 0]
#all 0s, 7 7 7, 0 CRC   orig zeros
#[0, 0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0,   2, 3, 3, 6, 7, 7, 0, 1, 3, 2, 4, 2, 2, 2, 7, 5, 0, 3, 3, 2,     5, 4, 3, 5,  7, 0, 3, 6,  4, 0, 7, 3,  0, 4, 1, 4,  4, 2, 7, 4,  6, 2, 0, 2,  0, 7, 6, 6,  1, 6, 4, 1,     5, 2, 3, 4,  4, 7, 5, 1,  1, 2, 5, 5,   5, 0, 6, 1,  0, 3, 1, 6,  4, 4, 0, 0]
dzeros_symbols = [4,4,4,0,4,0,4,0,2,4,6,0,0,0,0,0,6,4,2,0,0,0,4,0,0,0,0,0,0,0,0,0, 2,3,3,6, 7,7,0,1, 3,2,4,2, 2,2,7,5, 0,3,3,2,           5,4,3,5, 7,0,3,6, 4,0,7,3, 0,4,1,4, 4,2,7,4, 6,2,0,2, 0,7,6,6, 1,6,4,1,  5, 2, 3, 4,  4, 7, 5, 1,  1, 2, 5, 5,   5, 0, 6, 1,  0,3,1,6, 4,4,  0,0, 0,0,0,0] 
#so these kinda work but results don't make much more sense. Maybe my zeroes were right but the last 3 bytes are weird.

#trying to set zeros so baseline is 0 instead of a2a11
dzeros_symbols = [4, 4, 4, 0, 4, 0, 4, 0, 2, 4, 6, 0, 0, 0, 0, 0, 6, 4, 2, 0, 0, 0, 4, 4, 2, 7, 7, 4, 6, 7, 5, 6, 2, 3, 3, 6, 7, 7, 0, 1, 3, 2, 4, 2, 2, 2, 7, 5, 0, 3, 3, 2,    5, 4, 3, 5, 7, 0, 3, 6, 4, 0, 7, 3, 0, 4, 1, 4, 4, 2, 7, 4, 6, 2, 0, 2, 0, 7, 6, 6, 1, 6, 4, 1, 5, 2, 3, 4, 4, 7, 5, 1, 1, 2, 5, 5,    7, 5, 6, 2, 2, 6, 7, 5, 6, 0, 0, 0]
#oops preamble
dzeros_symbols = [4, 4, 4, 0, 4, 0, 4, 0, 2, 4, 6, 0, 0, 0, 0, 0, 6, 4, 2, 0, 0, 0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0, 2, 3, 3, 6, 7, 7, 0, 1, 3, 2, 4, 2, 2, 2, 7, 5, 0, 3, 3, 2,    5, 4, 3, 5, 7, 0, 3, 6, 4, 0, 7, 3, 0, 4, 1, 4, 4, 2, 7, 4, 6, 2, 0, 2, 0, 7, 6, 6, 1, 6, 4, 1, 5, 2, 3, 4, 4, 7, 5, 1, 1, 2, 5, 5,    7, 5, 6, 2, 2, 6, 7, 5, 6, 0, 0, 0 ,0,0,0,0]
...
if __name__ == "__main__":   #only run if this file is run as main script
	if 0: #verify with known values in temp3
		filename = "temp3.txt"
		print("Using {}\n".format(filename))	
